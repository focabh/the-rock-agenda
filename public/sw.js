...
const VERSION = "v33-qa-race-hardening";
...
self.addEventListener("activate", (event) => {
  event.waitUntil(
    (async () => {
      ...
      // Log técnico: confirma no DevTools (console) QUAL versão está ATIVA —
      // distingue "bundle antigo em cache" do SW atual sem UI pública.
      console.log("[SW] ativo:", VERSION);
    })()
  );
});
